...
public class StatsPieRenderer extends PieChartRenderer {
    public StatsPieRenderer(PieChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
    ...
    public void drawValues(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                if ((drawXOutside || drawYOutside) && (value >= 3f)) {
